...
function Hero() {
  ...
  return (
    <section className='w-full bg-[url(./assets/Img.png)] sm:bg-cover bg-contain'>
        <div className='text-white w-full md:w-[600px] xl:w-[700px] 2xl:w-[900px] pt-16 sm:pt-28 pb-20 space-y-2 sm:space-y-4 px-6 sm:px-12 md:px-20 xl:px-28 text-center md:text-start'>
